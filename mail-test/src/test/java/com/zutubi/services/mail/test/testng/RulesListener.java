package com.zutubi.services.mail.test.testng;
...
/**
 * See https://github.com/wolfs/testng-rules for details.
 */
public class RulesListener implements IHookable, ITestListener {
    ...
    public void run(IHookCallBack callBack, ITestResult testResult) {
        List<IHookable> hookables = getRules(testResult.getInstance(), IHookable.class);
